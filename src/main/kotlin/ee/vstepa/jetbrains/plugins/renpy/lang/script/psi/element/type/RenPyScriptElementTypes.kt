...
object RenPyScriptElementTypes {
    ...
    @JvmField val SHOW_STMT_WITH_CLAUSE = RenPyScriptElementType("REN_PY_SCRIPT_SHOW_WITH_CLAUSE")
    @JvmField val SHOW_STMT_WITH_CLAUSE_KEYWORD = RenPyScriptElementType("REN_PY_SCRIPT_SHOW_WITH_CLAUSE_KEYWORD")
    @JvmField val SHOW_STMT_WITH_CLAUSE_VALUE = RenPyScriptElementType("REN_PY_SCRIPT_SHOW_WITH_CLAUSE_VALUE")
