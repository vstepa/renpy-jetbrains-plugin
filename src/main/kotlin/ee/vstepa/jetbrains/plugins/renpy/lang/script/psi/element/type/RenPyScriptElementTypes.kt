...
object RenPyScriptElementTypes {
    ...
    @JvmField val SCENE_STMT_PROP_NAME = RenPyScriptElementType("REN_PY_SCRIPT_SCENE_STMT_PROP_NAME")
    @JvmField val SCENE_STMT_PROP_VAL = RenPyScriptElementType("REN_PY_SCRIPT_SCENE_STMT_PROP_VAL")
    ...
    @JvmField val SHOW_STMT_PROP_NAME = RenPyScriptElementType("REN_PY_SCRIPT_SHOW_STMT_PROP_NAME")
    @JvmField val SHOW_STMT_PROP_VAL = RenPyScriptElementType("REN_PY_SCRIPT_SHOW_STMT_PROP_VAL")
    ...
    @JvmField val HIDE_STMT_PROP_NAME = RenPyScriptElementType("REN_PY_SCRIPT_HIDE_STMT_PROP_NAME")
    @JvmField val HIDE_STMT_PROP_VAL = RenPyScriptElementType("REN_PY_SCRIPT_HIDE_STMT_PROP_VAL")
